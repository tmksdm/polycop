...
from logging_setup import mask_secret_url
...
# Логгер берём по имени. Это тот же объект, что настроил setup_logger().
...
async def run_watcher_mode() -> None:
    """
    Главная асинхронная функция watcher-режима.
    Раньше называлась main() и жила в main.py.
